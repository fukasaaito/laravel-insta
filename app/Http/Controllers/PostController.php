...
class PostController extends Controller
{
    ...
    public function show($id) //$id -> post's id
    {
    ...
    public function edit($id) { #only to access edit pagde
        $post = $this->post->findOrFail($id);
    ...
    public function update(Request $request, $id){
        ...
        //Equivalent: Delete FROM category_oist where post_id = $id;
        ...
        #5. Redirect to Show Post pafge (to confirm the update)
