...
class User extends Authenticatable
{
    ...
    public function followers()
    {
        ...
        //folloing_id can show who are following me
    }

    #To get all the users that the user is following / who am I following
    public function following()
    {
        return $this->hasMany(Follow::class, 'follower_id');
        //serch the follower_id colum with the ID to identify
    }
